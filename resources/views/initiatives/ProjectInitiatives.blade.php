 <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                     <div class="alert alert-success jesus" role="alert"><strong>Manage All  Projects that are attached to the Initiative :</strong> <strong><span style="color:black">{{$initiative->initiativeName}}</span></strong></div>
...
">{{$project->ProjectStatus}}</td>
                                                ...
                                                <td><a href="{{ route('ProjectEvents', ['id'=>$project->id]) }}" class="btn jesus  btn-dark"><i class="fas fas fa-binoculars "></i></a></td>
