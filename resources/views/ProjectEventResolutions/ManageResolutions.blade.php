  @include('main.head')
        ...
        @include('main.mainContent')<div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Manage All Project Events' Resolutions</h4>
                                    <p class="text-muted m-b-30">This interface allows you to manage all Resolutions attached to specific Events
                                         <a class="float-right btn btn-sm jesus btn-danger" href="{{route('ManageEvents')}}"><i class="fas fa-home"></i> Back to Project Events</a>
                                    </p>
