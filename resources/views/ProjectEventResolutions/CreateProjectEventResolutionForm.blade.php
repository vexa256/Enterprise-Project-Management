        ...
        @include('main.mainContent')
        			  ...
        			  <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Attach Resolution to a Project Event</h4>
        ...
        <form id="form-horizontal" class="form-horizontal form-wizard-wrapper" method="POST" action="{{url('/CreateProjectEventResolution')}}">
