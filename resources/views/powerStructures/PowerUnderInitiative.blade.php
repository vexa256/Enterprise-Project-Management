                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-success jesus" role="alert">  <h4 class="mt-0 header-title">  <h4 class="mt-0 header-title">Manage All Power Structures under the initiative  {{$initiatives->initiativeName}}</h4></div><p class="text-muted m-b-30">This interface gives you access to managing all Power Structures  under the initiative  {{$initiatives->initiativeName}}</p>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$PowerStructure->InitiativeName}}</td>
                                                  ...
                                                  <td><a href="{{ route('ManagePowerStructures', ['id'=>$PowerStructure->id]) }}" class="btn jesus btn-sm btn-primary timo"><i class="fas fa-clone "></i></a></td>
