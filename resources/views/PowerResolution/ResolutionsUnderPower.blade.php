                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-success jesus" role="alert">  <h4 class="mt-0 header-title">  <h4 class="mt-0 header-title">Manage All Resolutions attached to the Power Structure {{$PowerStructure->PowerStructureName}}</h4></div>
