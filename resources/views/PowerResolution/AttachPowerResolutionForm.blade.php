                  <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Attach Resolution to Power Structure</h4>
        ...
        <form id="form-horizontal" class="form-horizontal form-wizard-wrapper" method="POST" action="{{url('/CreatePowerResolution')}}">

                                        {{ csrf_field() }}

                                        <input type="hidden" name="PowerStructureName" value="{{$PowerStructure->PowerStructureName}}">
                                        <input type="hidden" name="PowerStructureID" value="{{$PowerStructure->PowerStructureID}}">
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9"><input value="{{$PowerStructure->PowerStructureName}}" name="" readonly type="text" class="form-control"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <fieldset>
                                                 ...
                                                 <div class="col-md-12">
                                                    <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <textarea name="ResolutionImplementationStatus"  type="text"  class="form-control editor" > Resolution Implementation Status </textarea></div>
                                                    </div>
                                                </div>
